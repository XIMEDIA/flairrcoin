...
TEST (node, mass_vote_by_hash)
{
	...
	for (auto i (0); i < 10000; ++i)
	{
		...
		auto block (std::make_shared<nano::state_block> (nano::dev_genesis_key.pub, previous, nano::dev_genesis_key.pub, nano::genesis_amount - (i + 1) * nano::gFLR_ratio, key.pub, nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (previous)));
		previous = block->hash ();
...
TEST (confirmation_height, long_chains)
{
	...
	// gFLR_ratio changed from Gxrb_ratio
	nano::send_block send (latest, key1.pub, nano::genesis_amount - nano::gFLR_ratio + num_blocks + 1, nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (latest));
	...
	auto previous_destination_chain_hash = open.hash ();
	{
		...
		{
			// gFLR_ratio changed from Gxrb_ratio
			nano::send_block send (previous_genesis_chain_hash, key1.pub, nano::genesis_amount - nano::gFLR_ratio + i + 1, nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (previous_genesis_chain_hash));
			ASSERT_EQ (nano::process_result::progress, node->ledger.process (transaction, send).code);
	...
	// gFLR_ratio changed from Gxrb_ratio
	nano::send_block send1 (previous_destination_chain_hash, nano::dev_genesis_key.pub, nano::gFLR_ratio - 2, key1.prv, key1.pub, *system.work.generate (previous_destination_chain_hash));
	// gFLR_ratio changed from Gxrb_ratio
	auto receive1 (std::make_shared<nano::state_block> (nano::dev_genesis_key.pub, previous_genesis_chain_hash, nano::genesis_account, nano::genesis_amount - nano::gFLR_ratio + 1, send1.hash (), nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (previous_genesis_chain_hash)));
	...
	nano::keypair key2;
	// gFLR_ratio changed from Gxrb_ratio
	nano::state_block send2 (nano::genesis_account, receive1->hash (), nano::genesis_account, nano::genesis_amount - nano::gFLR_ratio, key2.pub, nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (receive1->hash ()));
...
TEST (confirmation_height, prioritize_frontiers_overwrite)
{
	...
	auto ladev_genesis = node->latest (nano::dev_genesis_key.pub);
	// gFLR_ratio changed from Gxrb_ratio
	nano::send_block send (ladev_genesis, key.pub, nano::gFLR_ratio - 1, nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (ladev_genesis));
	...
	// gFLR_ratio changed from Gxrb_ratio
	nano::send_block send1 (send.hash (), key.pub, nano::gFLR_ratio - 2, nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (send.hash ()));
...
TEST (telemetry, many_nodes)
{
	...
	nano::state_block send (nano::dev_genesis_key.pub, genesis.hash (), nano::dev_genesis_key.pub, nano::genesis_amount - nano::mFLR_ratio, key.pub, nano::dev_genesis_key.prv, nano::dev_genesis_key.pub, *system.work.generate (genesis.hash ()));
