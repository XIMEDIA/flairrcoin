...
/**
 * "[peering-beta.flairrcoin.com]- changed from [peering-beta.nano.org]"
 * 
 * "[peering.flairrcoin.com]- changed from [peering.nano.org]"

 *[peering-test.flairrcoin.com] changed from [peering-test.nano.org]
 */
namespace
{
	...
	const char *default_test_peer_network = "peering-test.flairrcoin.com";
} // namespace

nano::node_config::node_config() : node_config(0, nano::logging())
{
}

nano::node_config::node_config(uint16_t peering_port_a, nano::logging const &logging_a) : peering_port(peering_port_a),
																						  logging(logging_a),
																						  external_address(boost::asio::ip::address_v6{}.to_string())
{
	...
	case nano::nano_networks::nano_live_network:
		...
		//"[Xxxxxxxxxxxxxxxxx_ChangeMe_Xxxxxxxxxxxxxxxxxxx]- changed from [A30E0A32ED41C8607AA9212843392E853FCBCB4E7CB194E35C94F07F91DE59EF]"
		preconfigured_representatives.emplace_back("Xxxxxxxxxxxxxxxxx_ChangeMe_Xxxxxxxxxxxxxxxxxxx");

		//"[Xxxxxxxxxxxxxxxxx_ChangeMe_Xxxxxxxxxxxxxxxxxxx]- changed from [67556D31DDFC2A440BF6147501449B4CB9572278D034EE686A6BEE29851681DF]"
		preconfigured_representatives.emplace_back("Xxxxxxxxxxxxxxxxx_ChangeMe_Xxxxxxxxxxxxxxxxxxx");
