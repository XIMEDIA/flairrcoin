...
TEST (network_filter, unit)
{
	...
	auto new_block (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, genesis.open->hash (), nano::test_genesis_key.pub, nano::genesis_amount - 10 * nano::FLR_ratio, nano::public_key (), nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0));
...
TEST (network_filter, many)
{
	...
	{
		// FLR_ratio changed from xrb_ratio
		auto block (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, genesis.open->hash (), nano::test_genesis_key.pub, nano::genesis_amount - i * 10 * nano::FLR_ratio, key1.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0));
