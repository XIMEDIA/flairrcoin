...
TEST (block_store, upgrade_v4_v5)
{
	...
	auto path (nano::unique_path ());
	{
		...
		nano::keypair key0;
		nano::send_block block0 (info.head, key0.pub, nano::genesis_amount - nano::gFLR_ratio, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
...
TEST (block_store, upgrade_sideband_two_blocks)
{
	...
	auto path (nano::unique_path ());
	{
		...
		store.version_put (transaction, 11);
		store.initialize (transaction, genesis);
		nano::state_block block (nano::test_genesis_key.pub, genesis.hash (), nano::test_genesis_key.pub, nano::genesis_amount - nano::gFLR_ratio, nano::test_genesis_key.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
		hash2 = block.hash ();
...
TEST (block_store, upgrade_sideband_two_accounts)
{
	...
	auto path (nano::unique_path ());
	{
		...
		store.version_put (transaction, 11);
		store.initialize (transaction, genesis);
		nano::state_block block1 (nano::test_genesis_key.pub, genesis.hash (), nano::test_genesis_key.pub, nano::genesis_amount - nano::gFLR_ratio, key.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
		hash2 = block1.hash ();
		ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, block1).code);
		nano::state_block block2 (key.pub, 0, nano::test_genesis_key.pub, nano::gFLR_ratio, hash2, key.prv, key.pub, 0);
		hash3 = block2.hash ();
...
TEST (block_store, upgrade_sideband_rollback_old)
{
	...
	store.version_put (transaction, 11);
	store.initialize (transaction, genesis);
	nano::send_block block1 (genesis.hash (), nano::test_genesis_key.pub, nano::genesis_amount - nano::gFLR_ratio, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, block1).code);
	nano::send_block block2 (block1.hash (), nano::test_genesis_key.pub, nano::genesis_amount - 2 * nano::gFLR_ratio, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, block2).code);
...
TEST (block_store, upgrade_sideband_epoch)
{
	...
	nano::state_block block2 (nano::test_genesis_key.pub, hash2, nano::test_genesis_key.pub, nano::genesis_amount - nano::gFLR_ratio, nano::test_genesis_key.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, block2).code);
...
TEST (block_store, sideband_height)
{
	...
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, change).code);
	nano::state_block state_send1 (nano::test_genesis_key.pub, change.hash (), 0, nano::genesis_amount - nano::gFLR_ratio, key1.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, state_send1).code);
	nano::state_block state_send2 (nano::test_genesis_key.pub, state_send1.hash (), 0, nano::genesis_amount - 2 * nano::gFLR_ratio, key2.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, state_send2).code);
	nano::state_block state_send3 (nano::test_genesis_key.pub, state_send2.hash (), 0, nano::genesis_amount - 3 * nano::gFLR_ratio, key3.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0);
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, state_send3).code);
	nano::state_block state_open (key1.pub, 0, 0, nano::gFLR_ratio, state_send1.hash (), key1.prv, key1.pub, 0);
	ASSERT_EQ (nano::process_result::progress, ledger.process (transaction, state_open).code);
	nano::state_block epoch (key1.pub, state_open.hash (), 0, nano::gFLR_ratio, ledger.epoch_link, epoch_key.prv, epoch_key.pub, 0);
	...
	nano::state_block state_receive (key2.pub, epoch_open.hash (), 0, nano::gFLR_ratio, state_send2.hash (), key2.prv, key2.pub, 0);
