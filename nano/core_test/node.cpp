...
TEST (node_config, v15_v16_upgrade)
{
	...
	test_upgrade ("peering-beta.flairrcoin.com", "peering-beta.flairrcoin.com");
}
...
TEST (node, block_confirm)
{
	...
	auto send1 (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, genesis.hash (), nano::test_genesis_key.pub, nano::genesis_amount - nano::gFLR_ratio, key.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, system.nodes[0]->work_generate_blocking (genesis.hash ())));
	...
	auto send2 (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, send1->hash (), nano::test_genesis_key.pub, nano::genesis_amount - nano::gFLR_ratio * 2, key.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, system.nodes[0]->work_generate_blocking (send1->hash ())));
	{
		auto transaction (system.nodes[0]->store.tx_begin (true));
...
TEST (node, confirm_quorum)
{
	...
	nano::uint128_union new_balance (system.nodes[0]->config.online_weight_minimum.number () - nano::gFLR_ratio);
