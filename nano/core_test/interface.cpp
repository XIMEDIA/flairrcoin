...
TEST (interface, xrb_uint256_to_address)
{
	...
	ASSERT_STREQ ("flr_1111111111111111111111111111111111111111111111111111hifc8npp", text);
}
...
{
	ASSERT_EQ (0, xrb_valid_address ("flr_1111111111111111111111111111111111111111111111111111hifc8npp"));
	ASSERT_EQ (1, xrb_valid_address ("flr_1111111111111111111111111111111111111111111111111111hifc8nppp"));
	ASSERT_EQ (1, xrb_valid_address ("flr_1111111211111111111111111111111111111111111111111111hifc8npp"));
}
