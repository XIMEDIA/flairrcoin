...
public:
	...
	publish_thresholds (is_live_network () ? publish_full : is_beta_network () ? publish_beta : publish_test)
	{
		...
		// change live ports
		default_node_port = is_live_network () ? 7095 : is_beta_network () ? 54000 : 44000;
		default_rpc_port = is_live_network () ? 7096 : is_beta_network () ? 55000 : 45000;
		default_ipc_port = is_live_network () ? 7097 : is_beta_network () ? 56000 : 46000;
		default_websocket_port = is_live_network () ? 7098 : is_beta_network () ? 57000 : 47000;
